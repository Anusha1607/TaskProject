(function (global, factory) {
	...
	(factory((global['ngx-drag-and-drop'] = {}),global.ng.core,global.ng.common));
...
DragDrop.propDecorators = {
    "drop": [{ type: core.HostListener, args: ['document: drop', ['$event'],] },],
    "dragover": [{ type: core.HostListener, args: ['document: dragover', ['$event'],] },],
    "dragenter": [{ type: core.HostListener, args: ['document: dragenter', ['$event'],] },],
    "dragleave": [{ type: core.HostListener, args: ['document: dragleave', ['$event'],] },],
    "dragend": [{ type: core.HostListener, args: ['document: dragend', ['$event'],] },],
    "mousemove": [{ type: core.HostListener, args: ['document: mousemove', ['$event'],] },],
    "mouseup": [{ type: core.HostListener, args: ['document: mouseup', ['$event'],] },],
    "touchmove": [{ type: core.HostListener, args: ['document: touchmove', ['$event'],] },],
    "touchend": [{ type: core.HostListener, args: ['document: touchend', ['$event'],] },],
};
...
Draggable.propDecorators = {
    "draggedData": [{ type: core.Input, args: ['draggable',] },],
    "startDelay": [{ type: core.Input, args: ['drag-start-delay',] },],
    "startDistance": [{ type: core.Input, args: ['start-distance',] },],
    "disabled": [{ type: core.Input, args: ['disabled',] },],
    "onDragStart": [{ type: core.Output, args: ['drag-start',] },],
    "onDragEnd": [{ type: core.Output, args: ['drag-end',] },],
...
Dropzone.decorators = [
    { type: core.Directive, args: [{ selector: '*[dropzone]' },] },
];
Dropzone.ctorParameters = function () { return [
    { type: core.ElementRef, },
]; };
Dropzone.propDecorators = {
    "dragCSS": [{ type: core.Input, args: ['drag-css',] },],
    "dragOverCSS": [{ type: core.Input, args: ['drag-over-css',] },],
    "dragOverCSS_pointer": [{ type: core.Input, args: ['drag-over-css-for-draggable',] },],
    "acceptFunction": [{ type: core.Input, args: ['accept-function',] },],
    "onDropEmitter": [{ type: core.Output, args: ['ondrop',] },],
    "onDragStart": [{ type: core.Output, args: ['drag-start',] },],
    "onDragEnd": [{ type: core.Output, args: ['drag-end',] },],
    "onDragEnter": [{ type: core.Output, args: ['drag-enter',] },],
    "onDragLeave": [{ type: core.Output, args: ['drag-leave',] },],
    "BrowserDragEnter": [{ type: core.HostListener, args: ['dragenter', ['$event'],] },],
    "BrowserDragLeave": [{ type: core.HostListener, args: ['dragleave', ['$event'],] },],
    "BrowserDrop": [{ type: core.HostListener, args: ['drop', ['$event'],] },],
};
